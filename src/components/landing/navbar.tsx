...
export function Navbar() {
  ...
  return (
    <nav className="absolute top-0 left-0 right-0 z-50 px-6 py-4 animate-fade-in" style={{ animationDelay: '0.1s' }}>
      <div className="max-w-6xl mx-auto px-4 py-2 flex justify-between items-center text-white">
        ...
        <div className="hidden md:flex items-center gap-4">
          <a href="#simulator" className="bg-white/10 hover:bg-white/20 text-white px-4 py-1.5 text-xs font-medium transition flex items-center gap-2 animate-glint rounded-md">
            Learn more
          </a>
        </div>
