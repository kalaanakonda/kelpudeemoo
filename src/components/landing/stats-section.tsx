        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 text-center md:text-left">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm leading-relaxed font-light mt-1">Assets Under Management</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm leading-relaxed font-light mt-1">Total Users</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm leading-relaxed font-light mt-1">KUSD APY</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm leading-relaxed font-light mt-1">rsETH APY</p>
            </div>
          </div>
