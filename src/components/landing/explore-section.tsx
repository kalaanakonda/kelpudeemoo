  ...
  return (
    <section className="bg-white py-24 border-b border-gray-100">
      <div className="max-w-6xl mx-auto px-6">
        <div className="mb-12">
          <h2 className="text-4xl md:text-5xl font-semibold font-heading text-black leading-tight tracking-tight mb-2">
            Explore Kelp
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 space-y-8">
            <Card className="bg-gray-50/50 hover:bg-gray-50 transition-colors border-gray-200 shadow-sm">
              <CardHeader className="flex-row items-start gap-4">
                ...
                <div>
                  <CardTitle className="text-lg font-semibold font-heading">Audits</CardTitle>
            ...
            <Card className="bg-gray-50/50 hover:bg-gray-50 transition-colors border-gray-200 shadow-sm">
              <CardHeader className="flex-row items-start gap-4">
                ...
                <div>
                  <CardTitle className="text-lg font-semibold font-heading">Bug Bounty</CardTitle>
          ...
          <div className="lg:col-span-2">
            <Card className="h-full shadow-lg border-gray-200">
              <CardHeader>
                <CardTitle className="text-2xl font-semibold font-heading flex items-center gap-2">
              ...
              <CardContent className="space-y-6 pt-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                    <div>
                        ...
                        <Input id="eth-amount" type="number" defaultValue={100} className="text-2xl h-14 p-4 font-semibold font-heading"/>
                    </div>
                    <div>
                        <Label htmlFor="apy" className="text-xs text-slate-500">Current APY</Label>
                        <div id="apy" className="text-2xl h-14 p-4 font-semibold font-heading border border-input rounded-md flex items-center bg-gray-50/70">
                            2.6%
                        </div>
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Card className="bg-gray-50/70 border-dashed">
                        <CardHeader>
                           ...
                           <CardTitle className="text-2xl font-semibold font-heading">0.22 rsETH</CardTitle>
                        </CardHeader>
                    </Card>
                     <Card className="bg-gray-50/70 border-dashed">
                        <CardHeader>
                           <CardDescription className="flex items-center gap-2 text-sm"><TrendingUp className="w-4 h-4" /> Yearly earnings</CardDescription>
                           <CardTitle className="text-2xl font-semibold font-heading">2.60 rsETH</CardTitle>
                        </CardHeader>
                    </Card>
                </div>
